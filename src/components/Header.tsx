          ...
          <div className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer" onClick={() => setActiveTab("optimize")}>
            ...
            <div>
              <div className="flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <span className="text-[10px] font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 px-1.5 py-0.5 rounded">v1.0.0</span>
                {onOpenUpdateModal && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    <span>⚡ {lang === "fa" || lang === "ar" ? "بررسی بروزرسانی" : "Check Update"}</span>
                  </button>
                )}
              </div>
